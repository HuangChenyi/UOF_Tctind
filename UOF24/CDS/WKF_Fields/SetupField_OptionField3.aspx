<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="SetupField_OptionField3.aspx.cs" Inherits="WKF_OptionalFields_SetupField_OptionField3" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><center><asp:Label ID="lblSingleLine" runat="server" Text="外掛欄位範例3" meta:resourcekey="lblSingleLineResource1"></asp:Label></center></td>
    </tr>
    <tr>
