...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><center><asp:Label ID="lblSingleLine" runat="server" Text="外掛欄位範例2" meta:resourcekey="lblSingleLineResource1"></asp:Label></center></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <asp:Label ID="Label4" runat="server" Text="品項可填寫者"></asp:Label>
        </td>
        <td colspan="3">
    ...
    <tr>
        <td>
            <asp:Label ID="Label1" runat="server" Text="最小值"></asp:Label>
        </td>
        <td>
            <telerik:RadNumericTextBox ID="rnumMin" runat="server"></telerik:RadNumericTextBox>
        </td>
        <td>
            <asp:Label ID="Label3" runat="server" Text="最大值"></asp:Label>
        </td>
        <td>
             <telerik:RadNumericTextBox ID="rnumMax" runat="server"></telerik:RadNumericTextBox>
        </td>
    </tr>
    <tr>
