...
public partial class WKF_OptionalFields_OptionFieldUC1 : WKF_FormManagement_VersionFieldUserControl_VersionFieldUC
{
    ...
    public override string Message
    {
        get
        {
            //表單訊息通知顯示的內容
            //回傳字串
            return m_versionField.FieldValue;
        }
    }
    ...
    public override bool IsFirstTimeWrite
    {
        get
        {
            ...
            if (m_versionField.Filler == null &&
                !string.IsNullOrEmpty(this.FieldValue))
            {
                return true;
            }
    ...
    {
        txtFieldValue.Visible= Enabled;
        lblFieldValue.Visible= !Enabled;
    }
    ...
    public override void SetField(Ede.Uof.WKF.Design.VersionField versionField)
    {
        ...
        {
           // base.taskObj.Applicant.UserGUID
            //base.taskObj.Agent_User
             //Current.UserGUID
            //base.ApplicantGuid
            //若有擴充屬性，可以用該屬性存取
